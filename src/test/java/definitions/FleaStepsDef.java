...
//    public void iAddItemsToCartAndVerifyCart(String nr) {
//        if (getDriver().findElement(By.xpath("//button[@class='single_add_to_cart_button button alt']")).isDisplayed()) {
//            getDriver().findElement(By.xpath("//input[@name='quantity']")).clear();
//            getDriver().findElement(By.xpath("//input[@name='quantity']")).sendKeys(nr);
...
//        } else
//            if (getDriver().findElement(By.xpath("//button[@class='single_add_to_cart_button button alt disabled wc-variation-is-unavailable']")).isDisplayed()) {
//                getDriver().findElement(By.xpath("//p[@class='stock out-of-stock']")).isDisplayed();
//        }
//    }
...
//    @When("I add {string} items to Cart and verify Cart")
//    public void iAddItemsToCartAndVerifyCart(String qt) {
//        switch (qt) {
//            case "button":
//                getDriver().findElement(By.xpath("//input[@name='quantity']")).clear();
//                getDriver().findElement(By.xpath("//button[@class='single_add_to_cart_button button alt']")).sendKeys(qt);
//                getDriver().findElement(By.xpath("//button[contains(text(),'Add to cart')]")).click();
//                getDriver().findElement(By.xpath("//div[@class='woocommerce-message']")).isDisplayed();
//                break;
//            case "disabled button":
//                getDriver().findElement(By.xpath("//input[@name='quantity']")).clear();
//                getDriver().findElement(By.xpath("//button[@class='single_add_to_cart_button button alt disabled wc-variation-is-unavailable']")).findElement(By.xpath("//p[@class='stock out-of-stock']"));
//        }
//    }
